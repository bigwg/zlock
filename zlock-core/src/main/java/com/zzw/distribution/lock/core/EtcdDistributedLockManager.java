...
public class EtcdDistributedLockManager implements DistributedLockManager {
    ...
    private EtcdSource etcdSource;

    public EtcdDistributedLockManager(EtcdSource etcdSource) {
        this.etcdSource = etcdSource;
    }
    ...
    public EtcdSource getEtcdSource() {
        return etcdSource;
    }

    public void setEtcdSource(EtcdSource etcdSource) {
        this.etcdSource = etcdSource;
    }
}
